        ...
        <div class="card-body">
            <form method="POST" action="/products/{{ $product->id }}">
                ...
                <div class="form-group my-1">
                    ...
                    <input type="text" id="kode" class="form-control" name="kode" value="{{ $product->kode }}">
                </div>
                <div class="form-group my-1">
                    <label for="nama">Nama:</label>
                    <input type="text" id="nama" class="form-control" name="nama" value="{{ $product->nama }}">
                </div>
                <div class="form-group my-1">
                ...
                <div class="form-group my-1">
                    ...
                    <input type="number" id="stok" class="form-control" name="stok" value="{{ $product->stok }}">
                </div>
                <div class="form-group my-1">
