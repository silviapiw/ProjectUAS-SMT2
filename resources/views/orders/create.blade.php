...
@section('content')
    <h1 class="mt-4">Ordes</h1>
    <div class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
            <li class="breadcrumb-item active"><a href="/orders" class="text-secondary">Ordes</a></li>
        </ol>
    </div>
    @if ($errors->any())
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form enctype="multipart/form-data" method="POST" action="/orders">
                @csrf
                ...
                <div class="form-group my-1">
                    <label for="jumlah_pesanan">Jumlah Order:</label>
                    <input type="number" id="jumlah_pesanan" class="form-control" name="jumlah_pesanan">
                </div>
                <div class="form-group my-1">
                    <label for="deskripsi">Deskripsi:</label>
                    <textarea type="textarea" id="deskripsi" class="form-control" name="deskripsi" rows="3"></textarea>
                </div>
                <div class="form-group my-1">
